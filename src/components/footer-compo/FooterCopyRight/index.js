    ...
    <div className='copyright-con'>
        <div className='icons-row'>
          ...
          <div className='row'>
            ...
            <a>
            New York State Housing and Anti-Discrimination Notic
            </a>
              <a>
